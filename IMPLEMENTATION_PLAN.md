...
**Step 2:** Refactor existing modals

**Files to update:**
- `frontend/components/agents/create-agent-modal.tsx`
- `frontend/components/agents/agent-details-modal.tsx`
...
- [ ] No custom modal chrome remains
