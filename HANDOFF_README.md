...
**Timeline:** 9.5 hours (2.5h Phase 1 + 7h Phase 2)  
...
- Phase 1 (2.5h) + Phase 2 (7h) breakdown

### 2. **Visual Reference Guides** (HTML files)
...
### Step 3: Execute Implementation Plan (9.5 hours)
...
- **Phase 2:** 7 deep fixes (7 hours)
  - Build EmptyState component
  - Migrate to FilterTabs everywhere
  - Build Modal component
  - Standardize hover states
  - Document spacing hierarchy
  - Document icon scale
  - Document Chat page exception
  - **Commit & verify**
...
**This 9.5-hour investment takes the platform from "promising MVP" to "polished product."**
